...
const _property_types_CostCurve = Dict{Symbol,String}(Symbol("variable_cost_type")=>"String", Symbol("value_curve")=>"CostCurveValueCurve", Symbol("power_units")=>"String", Symbol("vom_cost")=>"InputOutputCurve", )
