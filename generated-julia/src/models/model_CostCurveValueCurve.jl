...
function OpenAPI.property_type(::Type{ CostCurveValueCurve }, name::Symbol, json::Dict{String,Any})
    ...
    throw(OpenAPI.ValidationException("Invalid discriminator value: $discriminator for CostCurveValueCurve"))
end
