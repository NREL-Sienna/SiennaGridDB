...
Base.@kwdef mutable struct ThermalStandardOperationCost <: OpenAPI.APIModel
    ...
    function ThermalStandardOperationCost(variable, fixed, start_up, shut_down, )
        OpenAPI.validate_property(ThermalStandardOperationCost, Symbol("variable"), variable)
        OpenAPI.validate_property(ThermalStandardOperationCost, Symbol("fixed"), fixed)
        OpenAPI.validate_property(ThermalStandardOperationCost, Symbol("start_up"), start_up)
        OpenAPI.validate_property(ThermalStandardOperationCost, Symbol("shut_down"), shut_down)
        return new(variable, fixed, start_up, shut_down, )
    end
end # type ThermalStandardOperationCost

const _property_types_ThermalStandardOperationCost = Dict{Symbol,String}(Symbol("variable")=>"ThermalStandardOperationCostVariable", Symbol("fixed")=>"Float64", Symbol("start_up")=>"ThermalStandardOperationCostStartUp", Symbol("shut_down")=>"Float64", )
OpenAPI.property_type(::Type{ ThermalStandardOperationCost }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_ThermalStandardOperationCost[name]))}
...
function OpenAPI.validate_property(::Type{ ThermalStandardOperationCost }, name::Symbol, val)
end
