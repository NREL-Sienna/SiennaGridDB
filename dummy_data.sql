...
-- Add some operational data examples (via attributes, since operational_data is a view)
INSERT INTO attributes (entity_id, type, name, value) VALUES
    -- Entity 19: active_power_limits, must_run, time_limits, ramp_limits, operation_cost
    (19, 'operational', 'active_power_limits', json('{"min": 50.0}')),
    (19, 'operational', 'must_run', json('false')),
    (19, 'operational', 'time_limits', json('{"up": 4.0, "down": 2.0}')),
    (19, 'operational', 'ramp_limits', json('{"up": 10.0, "down": 15.0}')),
    (19, 'operational', 'operation_cost', json('{"variable_cost": 35.5, "startup_cost": 1000.0}')),
    -- Entity 20
    (20, 'operational', 'active_power_limits', json('{"min": 100.0}')),
    (20, 'operational', 'must_run', json('true')),
    (20, 'operational', 'time_limits', json('{"up": 0.5, "down": 0.25}')),
    (20, 'operational', 'ramp_limits', json('{"up": 50.0, "down": 50.0}')),
    (20, 'operational', 'operation_cost', json('{"variable_cost": 5.0, "startup_cost": 100.0}')),
    -- Entity 21
    (21, 'operational', 'active_power_limits', json('{"min": 0.0}')),
    (21, 'operational', 'must_run', json('false')),
    (21, 'operational', 'time_limits', json('{"up": 0.0, "down": 0.0}')),
    (21, 'operational', 'ramp_limits', json('{"up": 200.0, "down": 200.0}')),
    (21, 'operational', 'operation_cost', json('{"variable_cost": 0.0, "startup_cost": 0.0}')),
    -- Entity 22
    (22, 'operational', 'active_power_limits', json('{"min": 0.0}')),
    (22, 'operational', 'must_run', json('false')),
    (22, 'operational', 'time_limits', json('{"up": 0.0, "down": 0.0}')),
    (22, 'operational', 'ramp_limits', json('{"up": 100.0, "down": 100.0}')),
    (22, 'operational', 'operation_cost', json('{"variable_cost": 0.0, "startup_cost": 0.0}'));
