...
const TABLE_SCHEMAS = Dict(
    ...
    "storage_units" => Tables.Schema(
        [
            ...
            "base_power",
            "storage_capacity",
            "storage_level_limits_min",
            "storage_level_limits_max",
            "initial_storage_capacity_level",
            "input_active_power_limits_min",
            "input_active_power_limits_max",
            "output_active_power_limits_min",
            "output_active_power_limits_max",
            "efficiency_in",
            "efficiency_out",
            "reactive_power_limits_min",
            "reactive_power_limits_max",
