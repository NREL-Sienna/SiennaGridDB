...
const _property_types_LinearCurve = Dict{Symbol,String}(Symbol("marginal_cost")=>"Float64", Symbol("no_load_cost")=>"Float64", )
OpenAPI.property_type(::Type{ LinearCurve }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_LinearCurve[name]))}
