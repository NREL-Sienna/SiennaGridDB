...
Base.@kwdef mutable struct VariableReserveNonSpinning <: OpenAPI.APIModel
    ...
    function VariableReserveNonSpinning(available, deployed_fraction, id, max_output_fraction, max_participation_factor, name, requirement, sustained_time, time_frame, )
