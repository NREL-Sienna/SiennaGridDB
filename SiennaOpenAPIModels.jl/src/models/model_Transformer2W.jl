...
Base.@kwdef mutable struct Transformer2W <: OpenAPI.APIModel
    ...
    function Transformer2W(id, name, available, active_power_flow, reactive_power_flow, arc, r, x, primary_shunt, rating, base_power, base_voltage_primary, base_voltage_secondary, rating_b, rating_c, winding_group_number, )
        ...
        OpenAPI.validate_property(Transformer2W, Symbol("base_power"), base_power)
        OpenAPI.validate_property(Transformer2W, Symbol("base_voltage_primary"), base_voltage_primary)
        OpenAPI.validate_property(Transformer2W, Symbol("base_voltage_secondary"), base_voltage_secondary)
        ...
        OpenAPI.validate_property(Transformer2W, Symbol("winding_group_number"), winding_group_number)
        return new(id, name, available, active_power_flow, reactive_power_flow, arc, r, x, primary_shunt, rating, base_power, base_voltage_primary, base_voltage_secondary, rating_b, rating_c, winding_group_number, )
    end
