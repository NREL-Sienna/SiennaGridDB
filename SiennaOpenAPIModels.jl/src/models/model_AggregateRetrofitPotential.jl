...
Base.@kwdef mutable struct AggregateRetrofitPotential <: OpenAPI.APIModel
    ...
    function AggregateRetrofitPotential(retrofit_id, retrofit_potential, retrofit_fraction, uuid, )
        OpenAPI.validate_property(AggregateRetrofitPotential, Symbol("retrofit_id"), retrofit_id)
        OpenAPI.validate_property(AggregateRetrofitPotential, Symbol("retrofit_potential"), retrofit_potential)
        OpenAPI.validate_property(AggregateRetrofitPotential, Symbol("retrofit_fraction"), retrofit_fraction)
