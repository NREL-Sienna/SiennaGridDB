...
Base.@kwdef mutable struct StorageCost <: OpenAPI.APIModel
    ...
    function StorageCost(cost_type, charge_variable_cost, discharge_variable_cost, fixed, shut_down, start_up, energy_shortage_cost, energy_surplus_cost, )
        OpenAPI.validate_property(StorageCost, Symbol("cost_type"), cost_type)
        ...
        return new(cost_type, charge_variable_cost, discharge_variable_cost, fixed, shut_down, start_up, energy_shortage_cost, energy_surplus_cost, )
    end
