...
Base.@kwdef mutable struct StorageCost <: OpenAPI.APIModel
    ...
    function StorageCost(cost_type, charge_variable_cost, discharge_variable_cost, fixed, shut_down, start_up, energy_shortage_cost, energy_surplus_cost, )
        o = new(cost_type, charge_variable_cost, discharge_variable_cost, fixed, shut_down, start_up, energy_shortage_cost, energy_surplus_cost, )
...
function OpenAPI.validate_properties(o::StorageCost)
    ...
    OpenAPI.validate_property(StorageCost, Symbol("charge_variable_cost"), o.charge_variable_cost)
    OpenAPI.validate_property(StorageCost, Symbol("discharge_variable_cost"), o.discharge_variable_cost)
    ...
    OpenAPI.validate_property(StorageCost, Symbol("energy_shortage_cost"), o.energy_shortage_cost)
    OpenAPI.validate_property(StorageCost, Symbol("energy_surplus_cost"), o.energy_surplus_cost)
end
