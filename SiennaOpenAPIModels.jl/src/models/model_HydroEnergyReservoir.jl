...
function OpenAPI.check_required(o::HydroEnergyReservoir)
...
function OpenAPI.validate_properties(o::HydroEnergyReservoir)
    OpenAPI.validate_property(HydroEnergyReservoir, Symbol("active_power"), o.active_power)
    OpenAPI.validate_property(
        HydroEnergyReservoir,
        Symbol("active_power_limits"),
        o.active_power_limits,
    )
    OpenAPI.validate_property(HydroEnergyReservoir, Symbol("available"), o.available)
    OpenAPI.validate_property(HydroEnergyReservoir, Symbol("base_power"), o.base_power)
    OpenAPI.validate_property(HydroEnergyReservoir, Symbol("bus"), o.bus)
    OpenAPI.validate_property(
        HydroEnergyReservoir,
        Symbol("conversion_factor"),
        o.conversion_factor,
    )
    OpenAPI.validate_property(HydroEnergyReservoir, Symbol("id"), o.id)
    OpenAPI.validate_property(HydroEnergyReservoir, Symbol("inflow"), o.inflow)
    OpenAPI.validate_property(
        HydroEnergyReservoir,
        Symbol("initial_storage"),
        o.initial_storage,
    )
    OpenAPI.validate_property(HydroEnergyReservoir, Symbol("name"), o.name)
    OpenAPI.validate_property(
        HydroEnergyReservoir,
    ...
    OpenAPI.validate_property(HydroEnergyReservoir, Symbol("ramp_limits"), o.ramp_limits)
    OpenAPI.validate_property(HydroEnergyReservoir, Symbol("rating"), o.rating)
    OpenAPI.validate_property(
        HydroEnergyReservoir,
    ...
    OpenAPI.validate_property(HydroEnergyReservoir, Symbol("status"), o.status)
    OpenAPI.validate_property(
        HydroEnergyReservoir,
    ...
    OpenAPI.validate_property(HydroEnergyReservoir, Symbol("time_limits"), o.time_limits)
    OpenAPI.validate_property(
        HydroEnergyReservoir,
