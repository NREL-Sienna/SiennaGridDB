...
const _property_types_EnergyReservoirStorageEfficiency = Dict{Symbol,String}(Symbol("in")=>"Float64", Symbol("out")=>"Float64", )
OpenAPI.property_type(::Type{ EnergyReservoirStorageEfficiency }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_EnergyReservoirStorageEfficiency[name]))}

function check_required(o::EnergyReservoirStorageEfficiency)
    true
end

function OpenAPI.validate_property(::Type{ EnergyReservoirStorageEfficiency }, name::Symbol, val)
