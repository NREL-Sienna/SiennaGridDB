...
Base.@kwdef mutable struct ImportExportCost <: OpenAPI.APIModel
    ...
    function ImportExportCost(cost_type, import_offer_curves, export_offer_curves, energy_import_weekly_limit, energy_export_weekly_limit, )
        OpenAPI.validate_property(ImportExportCost, Symbol("cost_type"), cost_type)
        OpenAPI.validate_property(ImportExportCost, Symbol("import_offer_curves"), import_offer_curves)
        OpenAPI.validate_property(ImportExportCost, Symbol("export_offer_curves"), export_offer_curves)
        OpenAPI.validate_property(ImportExportCost, Symbol("energy_import_weekly_limit"), energy_import_weekly_limit)
        OpenAPI.validate_property(ImportExportCost, Symbol("energy_export_weekly_limit"), energy_export_weekly_limit)
        return new(cost_type, import_offer_curves, export_offer_curves, energy_import_weekly_limit, energy_export_weekly_limit, )
    end
...
function check_required(o::ImportExportCost)
