...
Base.@kwdef mutable struct TapTransformer <: OpenAPI.APIModel
    ...
    function TapTransformer(active_power_flow, arc, available, id, name, primary_shunt, r, rating, reactive_power_flow, tap, x, )
        ...
        return new(active_power_flow, arc, available, id, name, primary_shunt, r, rating, reactive_power_flow, tap, x, )
    end
end # type TapTransformer

const _property_types_TapTransformer = Dict{Symbol,String}(Symbol("active_power_flow")=>"Float64", Symbol("arc")=>"Int64", Symbol("available")=>"Bool", Symbol("id")=>"Int64", Symbol("name")=>"String", Symbol("primary_shunt")=>"Float64", Symbol("r")=>"Float64", Symbol("rating")=>"Float64", Symbol("reactive_power_flow")=>"Float64", Symbol("tap")=>"Float64", Symbol("x")=>"Float64", )
