...
Base.@kwdef mutable struct TapTransformer <: OpenAPI.APIModel
    ...
    function TapTransformer(id, name, available, active_power_flow, reactive_power_flow, arc, r, x, primary_shunt, tap, rating, base_power, base_voltage_primary, base_voltage_secondary, rating_b, rating_c, winding_group_number, control_objective, )
        ...
        OpenAPI.validate_property(TapTransformer, Symbol("active_power_flow"), active_power_flow)
        OpenAPI.validate_property(TapTransformer, Symbol("reactive_power_flow"), reactive_power_flow)
        ...
        OpenAPI.validate_property(TapTransformer, Symbol("base_power"), base_power)
        OpenAPI.validate_property(TapTransformer, Symbol("base_voltage_primary"), base_voltage_primary)
        OpenAPI.validate_property(TapTransformer, Symbol("base_voltage_secondary"), base_voltage_secondary)
        ...
        OpenAPI.validate_property(TapTransformer, Symbol("winding_group_number"), winding_group_number)
        OpenAPI.validate_property(TapTransformer, Symbol("control_objective"), control_objective)
        return new(id, name, available, active_power_flow, reactive_power_flow, arc, r, x, primary_shunt, tap, rating, base_power, base_voltage_primary, base_voltage_secondary, rating_b, rating_c, winding_group_number, control_objective, )
    end
end # type TapTransformer

const _property_types_TapTransformer = Dict{Symbol,String}(Symbol("id")=>"Int64", Symbol("name")=>"String", Symbol("available")=>"Bool", Symbol("active_power_flow")=>"Float64", Symbol("reactive_power_flow")=>"Float64", Symbol("arc")=>"Int64", Symbol("r")=>"Float64", Symbol("x")=>"Float64", Symbol("primary_shunt")=>"ComplexNumber", Symbol("tap")=>"Float64", Symbol("rating")=>"Float64", Symbol("base_power")=>"Float64", Symbol("base_voltage_primary")=>"Float64", Symbol("base_voltage_secondary")=>"Float64", Symbol("rating_b")=>"Float64", Symbol("rating_c")=>"Float64", Symbol("winding_group_number")=>"String", Symbol("control_objective")=>"String", )
OpenAPI.property_type(::Type{ TapTransformer }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_TapTransformer[name]))}
...
function OpenAPI.validate_property(::Type{ TapTransformer }, name::Symbol, val)
    ...
    if name === Symbol("winding_group_number")
        OpenAPI.validate_param(name, "TapTransformer", :enum, val, ["UNDEFINED", "GROUP_0", "GROUP_1", "GROUP_5", "GROUP_6", "GROUP_7", "GROUP_11"])
    end


    if name === Symbol("control_objective")
        OpenAPI.validate_param(name, "TapTransformer", :enum, val, ["UNDEFINED", "VOLTAGE_DISABLED", "REACTIVE_POWER_FLOW_DISABLED", "ACTIVE_POWER_FLOW_DISABLED", "CONTROL_OF_DC_LINE_DISABLED", "ASYMETRIC_ACTIVE_POWER_FLOW_DISABLED", "FIXED", "VOLTAGE", "REACTIVE_POWER_FLOW", "ACTIVE_POWER_FLOW", "CONTROL_OF_DC_LINE", "ASYMETRIC_ACTIVE_POWER_FLOW"])
    end
