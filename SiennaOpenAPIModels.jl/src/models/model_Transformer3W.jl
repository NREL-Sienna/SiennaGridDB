...
function OpenAPI.validate_properties(o::Transformer3W)
    ...
    OpenAPI.validate_property(Transformer3W, Symbol("secondary_star_arc"), o.secondary_star_arc)
    OpenAPI.validate_property(Transformer3W, Symbol("tertiary_star_arc"), o.tertiary_star_arc)
    OpenAPI.validate_property(Transformer3W, Symbol("star_bus"), o.star_bus)
    OpenAPI.validate_property(Transformer3W, Symbol("active_power_flow_primary"), o.active_power_flow_primary)
    OpenAPI.validate_property(Transformer3W, Symbol("reactive_power_flow_primary"), o.reactive_power_flow_primary)
    OpenAPI.validate_property(Transformer3W, Symbol("active_power_flow_secondary"), o.active_power_flow_secondary)
    OpenAPI.validate_property(Transformer3W, Symbol("reactive_power_flow_secondary"), o.reactive_power_flow_secondary)
    OpenAPI.validate_property(Transformer3W, Symbol("active_power_flow_tertiary"), o.active_power_flow_tertiary)
    OpenAPI.validate_property(Transformer3W, Symbol("reactive_power_flow_tertiary"), o.reactive_power_flow_tertiary)
    ...
    OpenAPI.validate_property(Transformer3W, Symbol("base_voltage_primary"), o.base_voltage_primary)
    OpenAPI.validate_property(Transformer3W, Symbol("base_voltage_secondary"), o.base_voltage_secondary)
    OpenAPI.validate_property(Transformer3W, Symbol("base_voltage_tertiary"), o.base_voltage_tertiary)
    OpenAPI.validate_property(Transformer3W, Symbol("g"), o.g)
    OpenAPI.validate_property(Transformer3W, Symbol("b"), o.b)
    OpenAPI.validate_property(Transformer3W, Symbol("primary_turns_ratio"), o.primary_turns_ratio)
    OpenAPI.validate_property(Transformer3W, Symbol("secondary_turns_ratio"), o.secondary_turns_ratio)
    OpenAPI.validate_property(Transformer3W, Symbol("tertiary_turns_ratio"), o.tertiary_turns_ratio)
    OpenAPI.validate_property(Transformer3W, Symbol("available_primary"), o.available_primary)
    OpenAPI.validate_property(Transformer3W, Symbol("available_secondary"), o.available_secondary)
    OpenAPI.validate_property(Transformer3W, Symbol("available_tertiary"), o.available_tertiary)
    ...
    OpenAPI.validate_property(Transformer3W, Symbol("primary_group_number"), o.primary_group_number)
    OpenAPI.validate_property(Transformer3W, Symbol("secondary_group_number"), o.secondary_group_number)
    OpenAPI.validate_property(Transformer3W, Symbol("tertiary_group_number"), o.tertiary_group_number)
    OpenAPI.validate_property(Transformer3W, Symbol("control_objective_primary"), o.control_objective_primary)
    OpenAPI.validate_property(Transformer3W, Symbol("control_objective_secondary"), o.control_objective_secondary)
    OpenAPI.validate_property(Transformer3W, Symbol("control_objective_tertiary"), o.control_objective_tertiary)
end
