...
Base.@kwdef mutable struct CapacityReserveMargin <: OpenAPI.APIModel
    ...
    function CapacityReserveMargin(name, uuid, id, available, eligible_regions, eligible_technologies, target_year, capacity_reserve_fraction, )
        o = new(name, uuid, id, available, eligible_regions, eligible_technologies, target_year, capacity_reserve_fraction, )
        OpenAPI.validate_properties(o)
        return o
    end
end # type CapacityReserveMargin

const _property_types_CapacityReserveMargin = Dict{Symbol,String}(Symbol("name")=>"String", Symbol("uuid")=>"String", Symbol("id")=>"Int64", Symbol("available")=>"Bool", Symbol("eligible_regions")=>"Vector{Int64}", Symbol("eligible_technologies")=>"Vector{Int64}", Symbol("target_year")=>"Int64", Symbol("capacity_reserve_fraction")=>"Float64", )
OpenAPI.property_type(::Type{ CapacityReserveMargin }, name::Symbol) = Union{Nothing,eval(Base.Meta.parse(_property_types_CapacityReserveMargin[name]))}
...
function OpenAPI.validate_properties(o::CapacityReserveMargin)
    ...
    OpenAPI.validate_property(CapacityReserveMargin, Symbol("uuid"), o.uuid)
    ...
    OpenAPI.validate_property(CapacityReserveMargin, Symbol("eligible_regions"), o.eligible_regions)
    OpenAPI.validate_property(CapacityReserveMargin, Symbol("eligible_technologies"), o.eligible_technologies)
    OpenAPI.validate_property(CapacityReserveMargin, Symbol("target_year"), o.target_year)
    OpenAPI.validate_property(CapacityReserveMargin, Symbol("capacity_reserve_fraction"), o.capacity_reserve_fraction)
end
