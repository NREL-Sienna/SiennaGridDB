...
Base.@kwdef mutable struct InterruptibleStandardLoad <: OpenAPI.APIModel
    ...
    function InterruptibleStandardLoad(
        id,
        name,
        available,
        bus,
...
const _property_types_InterruptibleStandardLoad = Dict{Symbol, String}(
    Symbol("id")=>"Int64",
    Symbol("name")=>"String",
...
OpenAPI.property_type(::Type{InterruptibleStandardLoad}, name::Symbol) =
    Union{Nothing, eval(Base.Meta.parse(_property_types_InterruptibleStandardLoad[name]))}
