...
@doc raw"""PhaseShiftingTransformer3W
    ...
    PhaseShiftingTransformer3W(;
        ...
        r_13=nothing,
        x_13=nothing,
        alpha_primary=nothing,
        alpha_secondary=nothing,
        alpha_tertiary=nothing,
    ...
    - r_13::Float64
    - x_13::Float64
    - alpha_primary::Float64
    - alpha_secondary::Float64
    - alpha_tertiary::Float64
...
Base.@kwdef mutable struct PhaseShiftingTransformer3W <: OpenAPI.APIModel
    ...
    alpha_primary::Union{Nothing, Float64} = nothing
    alpha_secondary::Union{Nothing, Float64} = nothing
    alpha_tertiary::Union{Nothing, Float64} = nothing
...
const _property_types_PhaseShiftingTransformer3W = Dict{Symbol, String}(
    Symbol("id") => "Int64",
    Symbol("name") => "String",
    ...
    Symbol("r_13") => "Float64",
    Symbol("x_13") => "Float64",
    Symbol("alpha_primary") => "Float64",
    Symbol("alpha_secondary") => "Float64",
    Symbol("alpha_tertiary") => "Float64",
    ...
    Symbol("base_voltage_tertiary") => "Float64",
    Symbol("g") => "Float64",
    Symbol("b") => "Float64",
...
function OpenAPI.check_required(o::PhaseShiftingTransformer3W)
    ...
    o.alpha_primary === nothing && (return false)
    o.alpha_secondary === nothing && (return false)
    o.alpha_tertiary === nothing && (return false)
...
function OpenAPI.validate_properties(o::PhaseShiftingTransformer3W)
    ...
    OpenAPI.validate_property(
        PhaseShiftingTransformer3W,
        Symbol("alpha_primary"),
        o.alpha_primary,
    )
    OpenAPI.validate_property(
        PhaseShiftingTransformer3W,
        Symbol("alpha_secondary"),
        o.alpha_secondary,
    )
    OpenAPI.validate_property(
        PhaseShiftingTransformer3W,
        Symbol("alpha_tertiary"),
        o.alpha_tertiary,
    )
    OpenAPI.validate_property(
        PhaseShiftingTransformer3W,
        Symbol("base_power_12"),
        o.base_power_12,
    )
    OpenAPI.validate_property(
        PhaseShiftingTransformer3W,
        Symbol("base_power_23"),
        o.base_power_23,
    )
    OpenAPI.validate_property(
        PhaseShiftingTransformer3W,
        Symbol("base_power_13"),
        o.base_power_13,
    )
    OpenAPI.validate_property(
        PhaseShiftingTransformer3W,
    ...
    OpenAPI.validate_property(
        PhaseShiftingTransformer3W,
        Symbol("base_voltage_tertiary"),
        o.base_voltage_tertiary,
    )
