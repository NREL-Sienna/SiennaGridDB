...
function OpenAPI.check_required(o::HydroPumpedStorage)
...
function OpenAPI.validate_properties(o::HydroPumpedStorage)
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("active_power"), o.active_power)
    ...
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("available"), o.available)
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("base_power"), o.base_power)
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("bus"), o.bus)
    OpenAPI.validate_property(
        HydroPumpedStorage,
        Symbol("conversion_factor"),
        o.conversion_factor,
    )
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("id"), o.id)
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("inflow"), o.inflow)
    OpenAPI.validate_property(
        HydroPumpedStorage,
        Symbol("initial_storage"),
        o.initial_storage,
    )
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("name"), o.name)
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("outflow"), o.outflow)
    OpenAPI.validate_property(
        HydroPumpedStorage,
    ...
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("ramp_limits"), o.ramp_limits)
    OpenAPI.validate_property(
        HydroPumpedStorage,
        Symbol("ramp_limits_pump"),
        o.ramp_limits_pump,
    )
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("rating"), o.rating)
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("rating_pump"), o.rating_pump)
    OpenAPI.validate_property(
        HydroPumpedStorage,
    ...
    OpenAPI.validate_property(
        ...
        o.reactive_power_limits_pump,
    )
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("status"), o.status)
    OpenAPI.validate_property(
        HydroPumpedStorage,
    ...
    OpenAPI.validate_property(HydroPumpedStorage, Symbol("time_limits"), o.time_limits)
    OpenAPI.validate_property(
        HydroPumpedStorage,
