...
Base.@kwdef mutable struct ConstantReserve <: OpenAPI.APIModel
    ...
    function ConstantReserve(available, deployed_fraction, id, max_output_fraction, max_participation_factor, name, requirement, reserve_direction, sustained_time, time_frame, )
