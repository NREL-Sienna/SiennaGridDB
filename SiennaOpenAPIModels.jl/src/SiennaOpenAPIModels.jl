...
@batteries PSY.Arc
@batteries PSY.Area
@batteries PSY.AreaInterchange
@batteries PSY.AverageRateCurve
@batteries PSY.AverageRateCurveFunctionData
@batteries PSY.ComplexNumber
@batteries PSY.ConstantReserve
@batteries PSY.ConstantReserveGroup
@batteries PSY.ConstantReserveNonSpinning
@batteries PSY.CostCurve
@batteries PSY.DCBus
@batteries PSY.EnergyReservoirStorage
@batteries PSY.ExponentialLoad
@batteries PSY.FixedAdmittance
@batteries PSY.FromTo
@batteries PSY.FromToToFrom
@batteries PSY.FuelCurve
@batteries PSY.FuelCurveFuelCost
@batteries PSY.HydroDispatch
@batteries PSY.HydroEnergyReservoir
@batteries PSY.HydroGenerationCost
@batteries PSY.HydroPumpedStorage
@batteries PSY.HydroStorageGenerationCost
@batteries PSY.InOut
@batteries PSY.IncrementalCurve
@batteries PSY.IncrementalCurveFunctionData
@batteries PSY.InterconnectingConverter
@batteries PSY.InterruptiblePowerLoad
...
@batteries PSY.LoadZone
@batteries PSY.MinMax
@batteries PSY.MonitoredLine
@batteries PSY.PhaseShiftingTransformer
@batteries PSY.PiecewiseLinearData
@batteries PSY.PiecewiseStepData
@batteries PSY.PowerLoad
@batteries PSY.ProductionVariableCostCurve
@batteries PSY.QuadraticFunctionData
@batteries PSY.RenewableNonDispatch
@batteries PSY.RenewableDispatch
@batteries PSY.RenewableGenerationCost
@batteries PSY.Source
@batteries PSY.StandardLoad
...
#@batteries PSY.Switched Admittance
@batteries PSY.TapTransformer
@batteries PSY.ThermalGenerationCost
@batteries PSY.ThermalGenerationCostStartUp
@batteries PSY.ThermalMultiStart
@batteries PSY.ThermalStandard
@batteries PSY.TModelHVDCLine
@batteries PSY.Transformer2W
@batteries PSY.TwoTerminalHVDCLine
@batteries PSY.TwoTerminalHVDCLineLoss
@batteries PSY.TwoTerminalVSCDCLine
@batteries PSY.UpDown
@batteries PSY.ValueCurve
@batteries PSY.VariableReserve
@batteries PSY.VariableReserveNonSpinning
