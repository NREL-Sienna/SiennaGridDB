...
function openapi2psy(transformer::PhaseShiftingTransformer, resolver::Resolver)
    ...
    PSY.PhaseShiftingTransformer(
        ...
        tap=transformer.tap,
        α=transformer.alpha,
        rating=transformer.rating / transformer.base_power,
        base_power=transformer.base_power,
        rating_b=transformer.rating_b / transformer.base_power,
        rating_c=transformer.rating_c / transformer.base_power,
