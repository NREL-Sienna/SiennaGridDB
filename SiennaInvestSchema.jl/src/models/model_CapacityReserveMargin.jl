...
Base.@kwdef mutable struct CapacityReserveMargin <: OpenAPI.APIModel
    ...
    function CapacityReserveMargin(name, uuid, id, available, eligible_regions, eligible_technologies, target_year, capacity_reserve_fraction, )
        ...
        OpenAPI.validate_property(CapacityReserveMargin, Symbol("eligible_regions"), eligible_regions)
        OpenAPI.validate_property(CapacityReserveMargin, Symbol("eligible_technologies"), eligible_technologies)
        OpenAPI.validate_property(CapacityReserveMargin, Symbol("target_year"), target_year)
        OpenAPI.validate_property(CapacityReserveMargin, Symbol("capacity_reserve_fraction"), capacity_reserve_fraction)
        return new(name, uuid, id, available, eligible_regions, eligible_technologies, target_year, capacity_reserve_fraction, )
    end
