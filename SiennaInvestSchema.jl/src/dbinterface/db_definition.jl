...
const TABLE_SCHEMAS = Dict(
    ...
    "supply_technologies" => Tables.Schema(
        ["id", "name", "prime_mover", "fuel", "area", "balancing_topology", "scenario"],
        [
            Int64,
            String,
            String,
    ...
    "storage_technologies" => Tables.Schema(
        ["id", "name", "prime_mover", "area", "balancing_topology", "scenario"],
        [
            Int64,
            String,
            String,
    ...
    "transport_technologies" => Tables.Schema(
        ["id", "name", "from_node_id", "to_node_id", "scenario"],
        [Int64, String, Union{Int64, Nothing}, Union{Int64, Nothing}, Union{String, Nothing}],
    ),
